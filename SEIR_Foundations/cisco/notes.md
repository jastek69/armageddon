        ...
        3 AI routes          ───────▶   Many reasoning zones
        
        1 external FM        ───────▶   Redundant FMs
        
        Company Cloud        ───────▶   Multiple company models
        
        1 On-Prem LLM        ───────▶   Multiple DC inference clusters
        
        Simple fallback      ───────▶   Policy-aware multi-tier failover
        
        NetworkPath          ───────▶   BGP + SD-WAN path intelligence
        
        Simple MCP           ───────▶   Federated MCP / AgentCore
        
        DataPolicy           ───────▶   Enterprise policy engine
        
        UserPolicy           ───────▶   Individual privacy restrictions
        
        Token estimate       ───────▶   AI FinOps / GPU capacity routing
        
        Telemetry            ───────▶   Full AI reasoning observability
        
        Single reasoning     ───────▶   Ensemble / consensus reasoning
